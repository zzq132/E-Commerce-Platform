...
async function getUserOrder() {
    let response=await getUserOrderAPI(params.value)
    orderList.value=response.result.items
    totalnum.value=response.result.count
}
      ...
      <div class="main-container">
        ...
        <div v-else>
          ...
          <div class="pagination-container">
             <el-pagination background layout="prev, pager, next" :page-size="params.pageSize" :total="totalnum" :current-change="pageChange" />
          </div>
        </div>
      </div>
